...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Harathi.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">K.Harathi.</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> Harathi
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="harathi.doc" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="bi.jpg" alt="bi.jpg"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm K.Harathi pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp;Computer Science and Engineering.</span> I am passionate about knowing new things in the world and I am also passionate about coding. Self-motivated, highly passionate, and hardworking fresh mind looking for an opportunity to work in a challenging organization to utilize and enhance my skills and knowledge to work for the growth of the organization.</p>
        <ul>
          <li>From - hindupur, India</li>
          <li>Lives in - Chinnapalli, India</li>
          <li>Age - 20</li>
          <li>Gender - Female</li>
        </ul>
      </section>
      <section id="Education" className="edu">
        ...
        <div className="time">
          <div className="con lef">
            <img src="apms1.jpg" alt="School Education" />
            <div className="text-box">
              <h2><span className="Special">School Education</span></h2>
              <small>2018-2019</small>
              <p>I Completed my School Education at Amar vidya Mandir SCHOOL, parigi,Hindupur</p>
              <p>I got 9.5 CGPA in my School Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
          <div className="con rig">
            <img src="apms2.jpg" alt="Intermediate Education" />
            <div className="text-box">
              <h2><span className="special">Intermediate MPC (Maths, Physics, Chemistry)</span></h2>
              <small>2019-2021</small>
              <p>I Completed my Intermediate Education at  Anantapur Narayana jr college, Anantapur.</p>
              <p>I got 8.5 CGPA in my Intermediate Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 7.5 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 8-43,<br /> Chinnapalli(v),<br /> Parigi(M),<br /> Anantapur(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="mailto:harthikuruba@gmail.com">harthikuruba@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 9347078094">9347078094</a></p>
            </div>
          </div>
